...
public class MarkToMarketAggregationResponseBucketData {
	...
	AggregationResponseBucketValue total_collateral_value;
	...
	public AggregationResponseBucketValue getTotal_collateral_value() {
		return total_collateral_value;
	}

	public void setTotal_collateral_value(AggregationResponseBucketValue total_collateral_value) {
