...
public class LoanSplitConsole extends AbstractConsole {
	...
	protected boolean prompt() {
		...
		System.out.print(ConsoleConfig.ACTING_PARTY.getPartyId() + " /loans/" + loan.getLoanId() + "/split/" + loanSplit.getLoanSplitId() + " > ");
		return true;
	}
	...
	public void handleArgs(String args[], BufferedReader consoleIn, WebClient webClient) {
		...
		if (args[0].equals("J")) {
			...
			try {
				...
				ApproveLoanSplitTask approveLoanSplitTask = new ApproveLoanSplitTask(webClient, loan, loanSplit,
